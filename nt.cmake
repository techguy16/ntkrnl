...
set(CMAKE_C_LINK_EXECUTABLE "<CMAKE_LINKER> ${LINK_FLAGS} <LINK_FLAGS> <OBJECTS> <LINK_LIBRARIES> ${LIBRARIES_${CMAKE_SYSTEM_PROCESSOR}}")
set(CMAKE_CXX_LINK_EXECUTABLE "<CMAKE_LINKER> ${LINK_FLAGS} <LINK_FLAGS> <OBJECTS> <LINK_LIBRARIES> ${LIBRARIES_${CMAKE_SYSTEM_PROCESSOR}}")
set(CMAKE_C_CREATE_SHARED_LIBRARY "<CMAKE_LINKER> ${LINK_FLAGS} <LINK_FLAGS> <OBJECTS> <LINK_LIBRARIES> ${LIBRARIES_${CMAKE_SYSTEM_PROCESSOR}} -dll")
set(CMAKE_CXX_CREATE_SHARED_LIBRARY "<CMAKE_LINKER> ${LINK_FLAGS} <LINK_FLAGS> <OBJECTS> <LINK_LIBRARIES> ${LIBRARIES_${CMAKE_SYSTEM_PROCESSOR}} -dll")
