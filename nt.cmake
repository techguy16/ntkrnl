...
set(CMAKE_C_LINK_EXECUTABLE "<CMAKE_LINKER> ${LINK_FLAGS} <LINK_FLAGS> <OBJECTS> <LINK_LIBRARIES> -out:<TARGET>")
set(CMAKE_CXX_LINK_EXECUTABLE "<CMAKE_LINKER> ${LINK_FLAGS} <LINK_FLAGS> <OBJECTS> <LINK_LIBRARIES> -out:<TARGET>")
set(CMAKE_C_CREATE_SHARED_LIBRARY "<CMAKE_LINKER> ${LINK_FLAGS} <LINK_FLAGS> <OBJECTS> <LINK_LIBRARIES> -dll -out:<TARGET>")
set(CMAKE_CXX_CREATE_SHARED_LIBRARY "<CMAKE_LINKER> ${LINK_FLAGS} <LINK_FLAGS> <OBJECTS> <LINK_LIBRARIES> -dll -out:<TARGET>")
