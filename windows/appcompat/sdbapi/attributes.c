...
--*/
{
    ...
    //
    pContext->pfnVerQueryValue = (PFNVerQueryValue)SdbpVerQueryValue;
...
BOOL
SdbpCheckAttribute(
    IN  HSDB        hSDB,   // Database Context pointer
...
SdbpCheckAllAttributes(
    IN  HSDB        hSDB,   // pointer to the database channel
...
SdbpQueryVersionString(
    IN  HSDB             hSDB,       // the database channel
