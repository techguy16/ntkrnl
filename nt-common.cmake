...
set(CMAKE_C_FLAGS_INIT "-fms-compatibility ${CLANGWARNINGS} --target=${CLANGARCH} ${ARCHDEFS}")
set(CMAKE_CXX_FLAGS_INIT "-fms-compatibility ${CLANGWARNINGS} --target=${CLANGARCH} ${ARCHDEFS}")
